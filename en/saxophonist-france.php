...
<body>
    ...
    <div class="main-wrap">
        <!-- ABOUT-FRANCE -->
        <?php include "../common-php/pages-content/france/about-en.html"; ?>
        <!-- /ABOUT-FRANCE -->

        <!-- EVENTS-FRANCE -->
        <?php include "../common-php/pages-content/france/events-en.html"; ?>
        <!-- /EVENTS-FRANCE -->

        <!-- REC-FRANCE -->
        <?php include"../common-php/pages-content/france/rec-en.html"; ?>
        <!-- /REC-FRANCE -->
