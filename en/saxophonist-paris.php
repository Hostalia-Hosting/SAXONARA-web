...
<body>
    ...
    <!-- COMMON-HERO -->
    <?php include "../common-php/hero/en-paris.html"; ?>
    <!-- /COMMON-HERO -->
     
    <div class="main-wrap">
    	<!-- ABOUT-PARIS -->
        <?php include "../common-php/pages-content/paris/about-en.html"; ?>
        <!-- /ABOUT-PARIS -->

        <!-- EVENTS-PARIS -->
        <?php include "../common-php/pages-content/paris/events-en.html"; ?>
        <!-- /EVENTS-PARIS -->
