...
<body>
    ...
    <div class="main-wrap">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-xs-12">
                        <div class="section-header text-center style-3">
                            ...
                            <p class="section-subtext"><b>My favorite styles?</b> I adapt my shows to each event, so playing <strong>romantic music on saxophone</strong> at a <a href="/en/saxophonist-wedding-ceremony.php">Wedding Ceremony</a> is not going to be the same as playing my <strong>saxophone with LED lights</strong> on the stage of a nightclub. I love to adapt to each event, in an <strong>elegant</strong> way and seeking to satisfy the client, so I'm also open to <b>requests</b> to make the event unique.</p>
        ...
        <?php include "../common-php/videos/videos-main-en.html"; ?>
        <!-- /COMMON-PHP VIDEOS-MAIN -->
        ...
        <div class="section purchase-section text-white">
            <div class="overlay section-padding">
                ...
                <?php include "../common-php/videos/divider01-en.html"; ?>
